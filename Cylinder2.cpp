...
Cylinder2::Cylinder2(float baseRadius, float topRadius, float height, int radialDivision, int heightDivision, const std::string& texturePath)
...
void Cylinder2::init(float baseRadius, float topRadius, float height, int radialDivision, int heightDivision) {
...
void Cylinder2::Draw(Shader& shader, const glm::mat4& transform) {
    shader.use();
    glBindVertexArray(VAO);
...
GLuint Cylinder2::loadTexture(const char* path) {
    GLuint textureID;
